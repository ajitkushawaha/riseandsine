  ...
  return (
    <section id="top" className="relative isolate min-h-screen overflow-hidden pt-20 pb-12 bg-white-pure">
      ...
      <div className="absolute inset-x-0 top-0 -z-10 transform-gpu overflow-hidden blur-3xl" aria-hidden="true">
        <div
          className="relative left-[calc(50%-11rem)] aspect-1155/678 w-xl -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-accent to-amber-200 opacity-20 sm:left-[calc(50%-30rem)] sm:w-[72rem]"
          style={{
            clipPath:
